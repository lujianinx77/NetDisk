...
<head>
	...
	<script src=<%=request.getContextPath()+"/resources/js/um/forgetpwd.js" %>></script>
	<title>NetDisk-ForgetPassword</title>
</head>
<body >
	<div class="container">
		<form class="form-signin"  onsubmit="return false;">
			<h2 class="form-singin-heading">ForgetPassword</h2>
			...
			<button class="btn btn-lg btn-primary btn-block"  onclick="register();" type="submit" style="pointer-events: auto;margin-top:11px;">修改密码</button>
			<div class="alert alert-success hide" id="registerSuccessDiv">修改成功，1S后跳转到<a href="login">主页</a></div>
		</form>
	</div>
</body>
</html>
