...
<head>
	...
	<script src=<%=request.getContextPath()+"/resources/js/userinfoManager/newuser.js" %>></script>
				...
				<form action="newUserAction" method="post">
					<div id="Credentials">
						<div class="container">
							...
							<div id="registerSuccessTip" class="hide"><label class="text-base">注册成功！1S后跳转到<a href="index" class="display-inline-block">主页</a>.</label></div>
						</div>
					</div>
				</form>
			</div>
